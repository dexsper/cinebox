...
- На главной: недавно просмотренные, ваши списки "Смотрю" и "Запланировано", сейчас в кино, тренды за день и за неделю, популярное и с высоким рейтингом. Лишние подборки можно скрыть в настройках
- Боковое меню с разделами: Фильмы, Мультфильмы, Сериалы, Аниме. В каждом свои подборки: прошлый год, стоит пересмотреть, с высоким рейтингом, жанры, десятилетия, студии
- Подбор: любой раздел можно отфильтровать по жанрам, десятилетию, минимальному рейтингу и сортировке
- Свои списки: Смотрю, Запланировано, Просмотрено, Брошено, плюс Нравится. При запуске просмотра тайтл сам попадает в "Смотрю"
...
- На постере видно, если уже смотрели, и в каком он списке
- История просмотра хранится локально: воспроизведение продолжается с того места по фильму или серии
- Опционально таймкод можно вести и на TorrServer (в настройках, по умолчанию выкл.). Если есть и локальная запись, берется она
...
- Для той же раздачи запоминаются выбранные звуковая дорожка и субтитры, скорость и масштаб картинки
...
- Пропуск интро, "ранее", титров и превью: кнопки появляются при входе в зону пропуска; нажмите Пропустить один раз и приложение запомнит — в следующий раз само отсчитает 8 с и пропустит
